    ...
    if val != '':
        ...
        if(intval<vahicalDistance and intval>0 and isGetShot):
            ...
            if result:
                ...
                def DatabaseUpdate(VehicalNumber):
                    #update data
                    data = {
                        'exit':Exit,
                        'exdate' : day,
                    ...
                    db.collection('Vehical').document(VehicalNumber).update(data)
                ...
                print("\n\nExit place Vehical found : "+NumberPlate+"\n\n")
                
                DatabaseUpdate(NumberPlate)
